...
## run kreadconfig5 to get the NONLINEAR sRGB value that the accent is set to.
...
## check if the tint factor is disabled
if [[ -z $(kreadconfig5 --file $COLORSCHEME_PATH --group General --key TintFactor) ]]; then
    TINT_FACTOR="0"
else
